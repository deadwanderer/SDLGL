...
set AdditionalCpps= ..\hex\hex.cpp ..\hex\Game.cpp ..\hex\mesh.cpp ..\hex\InputManager.cpp ..\hex\Clock.cpp ..\hex\glad.c
...
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% %AdditionalCpps% /link %CommonLinkerFlags%
popd